...
export default class AddStoryPage {
    ...
    return `
            <section class="add-story view-transition-content">
                <div class="heading--container" aria-label="Heading Container">
                    ...
                    <p aria-label="Deskripsi Add Story Page">Buat Story kamu sendiri di sini!</p>
                </div>

                <form id="storyForm" class="story-form" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="camera-preview">Kamera</label>
                      <div id="camera-preview" class="camera-preview">
                          ...
                          <button type="button" id="retakeBtn" style="display: none;"  aria-label="Ambil foto" class="capture-btn">
                            <span>🔄</span>
                          </button>
                      </div>
                    </div>

                    <div id="unggahFoto" class="form-group" style="display: none;">
                        <label for="photoFile">Unggah Foto</label>
                        <input 
                        type="file" 
                        id="photoFile" 
                        name="photo" 
                    ...
                    <div class="form-group">
                        ...
                        id="description" 
                        name="description" 
                        placeholder="Ceritakan foto yang anda tangkap atau unggah..." 
                        required
                        maxlength="1000"
                        rows="5"
                        ></textarea>
  ...
  async afterRender() {
    ...
    document
      ...
      .addEventListener('click', () => this.handleRetakeButtonClick());
  ...
  showCameraError(message) {
    ...
    `;
    document.getElementById('unggahFoto').style.display = "flex";
  }
